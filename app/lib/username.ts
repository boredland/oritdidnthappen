const ADJECTIVES = [
  "quiet", "calm", "bright", "gentle", "swift", "bold", "wise", "merry",
  "noble", "warm", "amber", "ivory", "velvet", "golden", "silver", "dusky",
  "misty", "sunny", "lively", "graceful", "humble", "clever", "cosmic",
  "dapper", "earnest", "fabled", "honest", "jolly", "keen", "lucky", "mellow",
  "nimble", "opal", "plucky", "regal", "serene", "tender", "upbeat", "vivid",
  "witty", "zesty", "azure", "crimson", "emerald", "hazel", "indigo", "jade",
  "saffron", "topaz",
];

const ANIMALS = [
  "otter", "heron", "fox", "lynx", "robin", "sparrow", "finch", "wren",
  "marten", "stoat", "hare", "deer", "badger", "owl", "raven", "magpie",
  "swift", "swallow", "kestrel", "falcon", "ibis", "egret", "crane", "plover",
  "puffin", "seal", "dolphin", "marlin", "perch", "tench", "carp", "pike",
  "beetle", "cricket", "firefly", "moth", "bee", "hawk", "eagle", "gull",
  "tern", "petrel", "quail", "snipe", "thrush", "linnet", "siskin", "vole",
  "marmot", "pika",
];
